(function() {
	tinymce.PluginManager.add('youtube_mce_button', function(editor, url) {
		editor.addButton('youtube_mce_button', {
			text: 'Видео',
			icon: false,
			onclick: function() {
				editor.windowManager.open( {
					title: 'Видео с подписью',
					body: [
						{
							type: 'textbox',
							name: 'url',
					...
					onsubmit: function(e) {
						...
						editor.insertContent('[youtube url="'+e.data.url+'" src="'+e.data.src+'" '+attrs_array.join(' ')+']');
					}
				});
			}
		});
